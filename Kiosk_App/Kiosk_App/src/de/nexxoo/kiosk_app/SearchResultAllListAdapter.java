 ...
 */
public class SearchResultAllListAdapter extends ArrayAdapter<BaseEntity> {
	...
	public SearchResultAllListAdapter(Context context, int layoutId, List<BaseEntity> objects) {
