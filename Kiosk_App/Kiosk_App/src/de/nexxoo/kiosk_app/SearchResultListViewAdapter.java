 ...
 */
public class SearchResultListViewAdapter extends ArrayAdapter<Manual> {
	...
	public SearchResultListViewAdapter(Context context, int layoutId, List<Manual> objects) {
