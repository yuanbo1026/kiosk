 ...
 */
public class SearchResultPDFGridViewAdapter extends ArrayAdapter<Manual> {
	...
	public SearchResultPDFGridViewAdapter(Context context, int layoutId, List<Manual> objects) {
