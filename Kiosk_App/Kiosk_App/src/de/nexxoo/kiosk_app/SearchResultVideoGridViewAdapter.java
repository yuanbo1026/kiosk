 ...
 */
public class SearchResultVideoGridViewAdapter extends ArrayAdapter<Video> {
	...
	public SearchResultVideoGridViewAdapter(Context context, int layoutId, List<Video> objects) {
